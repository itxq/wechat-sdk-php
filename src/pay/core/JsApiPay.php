 ...
 *        概    要: JsAPI支付实现类
 *        作    者: IT小强
 *        创建时间: 2017/8/25 18:04
 *        修改时间:
 *        copyright (c) 2016 - 2018 mail@xqitw.cn
 *  ==================================================================
 */

namespace itxq\wechat\pay\core;

use itxq\wechat\lib\Tools;

/**
 * Class JsApiPay - JsAPI支付实现类
 * 该类实现了从微信公众平台获取code、通过code获取openid和access_token、
 * 生成JsApi支付js接口所需的参数、生成获取共享收货地址所需的参数
 * @package itxq\wechat\pay\core
 */
class JsApiPay
{
    /**
    ...
    /**
     * @var  \itxq\wechat\pay\WxPayConfig - 微信配置类
     */
    private $wxPayConfig;
    
    /**
     * JsApiPay 构造函数.
     * @param \itxq\wechat\pay\WxPayConfig $config - 微信配置信息
     * @throws \Exception
     */
    ...
    public function GetOpenid() {
        //通过code获得openid
        $code = strip_tags(Tools::getSubValue('code', $_GET, ''));
        $baseUrl = urlencode(Tools::getUrl());
     ...
     * @param bool $isJson - 是否为json格式
     * @throws \WxPayException
     * @return string|array 返回数组或者json （json数据，可直接填入js函数作为参数）
     */
    ...
    public function GetEditAddressParameters() {
        ...
        $time = strval(time());
        $data['timestamp'] = $time;
        $data['noncestr'] = Tools::cmRound(8, 'num');
