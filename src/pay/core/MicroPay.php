...
{
    /**
     * @var \itxq\wechat\pay\WxPayConfig|bool - 微信配置类
     */
    private $wxPayConfig;
    
    /**
     * MicroPay 构造函数.
     * @param \itxq\wechat\pay\WxPayConfig|bool $config - 微信配置信息
     */
    ...
    public function pay($microPayInput) {
        //①、提交被扫支付
        $result = \WxPayApi::micropay($this->wxPayConfig, $microPayInput, 5);
        //如果返回成功
